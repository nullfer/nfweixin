...
//        wx.getMsgTextList();
		...
		piece.setContent("第一个第一个第一个第一个第一个第一个");
		piece.setDigest("第一个第一个");
		piece.setImg(img);
		piece.setTitle("第一个");
		pieces.add(piece);

		ImgTextForm.Piece piece1 = new ImgTextForm.Piece();
		piece1.setContent("第二个第二个第二个第二个第二个第二个");
		piece1.setDigest("第二个第二个");
		piece1.setImg(img);
		piece1.setTitle("第二个");
		pieces.add(piece1);

		ImgTextForm.Piece piece2 = new ImgTextForm.Piece();
		piece2.setContent("第三个第三个第三个第三个第三个第三个");
		piece2.setDigest("第三个第三个");
		piece2.setImg(img);
		piece2.setTitle("第三个");
		pieces.add(piece2);
